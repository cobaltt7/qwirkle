...
For anyone who knows [Git](https://git-scm.com) and JavaScript basics: feel free to contribute to this repository! Our code is open source. Be sure to follow our [code of conduct](https://github.com/RedGuy12/qwirkle/blob/main/CODE_OF_CONDUCT.md).
...
Found a bug? Report it! Be sure to check if it is already reported by using the search bar [here](https://github.com/RedGuy12/qwirkle/issues). If there are no similar issues, you can create a new one. We will take a look at it.
